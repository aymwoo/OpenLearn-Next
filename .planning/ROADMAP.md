...
**Plans**: 3 plans
- [ ] 67-01-PLAN.md — DATA-01 校验地基：dataModel Zod meta-schema（纯 DTO）+ 1 合法/5 非法负样本 + 合法 quiz 样板声明 + 依赖/脚本入口
...
|-------|-----------|----------------|--------|-----------|
| 67. Declarative Plugin-Owned Data Model & Migration-Proof | v4.0 | 0/3 | Planned | - |
