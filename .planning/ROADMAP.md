...
**Status:** ✅ Complete (all v4.0 phases finished 2026-06-05)
...
- ✅ **v4.0 Plugin Marketplace & Plugin-Owned Data** - Phases 67-72 (completed 2026-06-05). See `.planning/REQUIREMENTS.md`.
...
<details open>
<summary>✅ v4.0 Plugin Marketplace & Plugin-Owned Data (Phases 67-72) — COMPLETE 2026-06-05</summary>
...
- [x] 71-01-PLAN.md — Phase 71 verifier seed + proof lane（真实 quiz data / retain / live-session fixtures）

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 71-02-PLAN.md — external catalog + install preflight + retain-recover backend contract

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 71-03-PLAN.md — semver upgrade / cleanup audit / active-session blocker backend contract

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 71-04-PLAN.md — `/settings/plugins` dual-section lifecycle UI（preflight-first / recover / block reason）
...
- [x] 72-01-PLAN.md — aggregate Phase 67-71 proof lanes into milestone-authoritative `verify:phase` and sync v4.0 bookkeeping
