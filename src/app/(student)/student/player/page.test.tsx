...
describe("StudentPlayerPage", () => {
  it("keeps the route split between shell loading and a separate personal slot", () => {
    ...
    expect(playerPageSource).toContain("PlayerPersonalFallback shell={shell}");
    ...
    expect(playerPageSource).toContain('error.message === INACCESSIBLE_LESSON_MESSAGE');
    expect(playerPageSource).not.toContain("} catch {");
  });
