...
export default function HomePage() {
  return (
    <main className="h-screen overflow-hidden flex flex-col bg-background text-on-background font-body-md">
      ...
      {/* Main Content Area */}
      <div className="flex-1 pt-16 flex flex-col md:flex-row items-center justify-center p-6 md:p-12 gap-12 bg-gradient-to-br from-surface to-surface-container-low">
        ...
        <div className="flex-1 max-w-2xl flex flex-col items-center text-center space-y-8">
          ...
          <div className="w-full max-w-md rounded-xl overflow-hidden shadow-[0_8px_32px_rgba(44,47,49,0.06)] relative border border-surface-container-high">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4 text-left">
              <span className="font-chip-tag text-chip-tag bg-secondary-container text-on-secondary-container px-2 py-1 rounded-full mb-2 inline-block">Featured</span>
              <h3 className="font-headline-lg text-headline-lg text-white text-lg">数据科学基础</h3>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md bg-surface-container-lowest rounded-xl p-8 shadow-[0_8px_32px_rgba(44,47,49,0.06)] border border-surface-container">
          <div className="text-center mb-8">
            <h2 className="font-headline-lg text-headline-lg text-on-background mb-2">欢迎回来</h2>
            <p className="font-body-md text-body-md text-on-surface-variant">请登录您的账户继续学习</p>
          </div>
          ...
          <form className="space-y-4">
            <div>
              <label className="font-label-sm text-label-sm text-on-surface-variant block mb-1">邮箱地址</label>
              <input 
            ...
            <div>
              <label className="font-label-sm text-label-sm text-on-surface-variant block mb-1">密码</label>
              <input 
                className="w-full bg-surface-container-low border-transparent focus:border-primary focus:ring-2 focus:ring-primary/20 rounded-lg px-4 py-3 text-on-surface transition-all" 
                placeholder="••••••••" 
                type="password" 
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="font-label-sm text-label-sm text-on-surface-variant">记住我</span>
              </label>
