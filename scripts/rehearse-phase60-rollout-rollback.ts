...
export const PHASE60_TRANSPORT_FALLBACK_MANUAL_NOTE = "manual evidence only; update `ops/releases/evidence/phase60/transport-fallback-notes.md` during the live rehearsal and do not treat it as an automated pass bit.";
