...
LOCAL_ROOT=${OPENLEARN_LOCAL_PILOT_HOST_ROOT:-"${XDG_DATA_HOME:-$HOME/.local/share}/openlearn/local-pilot-host"}
...
OPENLEARN_RELEASE_SCHOOL_ID=${OPENLEARN_RELEASE_SCHOOL_ID:-school-1}
OPENLEARN_RELEASE_CLASSROOM_SESSION_ID=${OPENLEARN_RELEASE_CLASSROOM_SESSION_ID:-session-1}
OPENLEARN_RELEASE_LESSON_VERSION_ID=${OPENLEARN_RELEASE_LESSON_VERSION_ID:-lesson-v1}
OPENLEARN_RELEASE_PLUGIN_ID=${OPENLEARN_RELEASE_PLUGIN_ID:-plugin-voting-proof}
OPENLEARN_RELEASE_ACTION_KEY=${OPENLEARN_RELEASE_ACTION_KEY:-launchVote}
OPENLEARN_RELEASE_COMMAND_ID=${OPENLEARN_RELEASE_COMMAND_ID:-command-1}
OPENLEARN_RELEASE_TASK_ID=${OPENLEARN_RELEASE_TASK_ID:-task-1}
