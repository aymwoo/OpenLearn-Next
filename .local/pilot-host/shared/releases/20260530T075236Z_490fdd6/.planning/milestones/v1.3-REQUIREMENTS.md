# Requirements Archive: v1.3 Teaching Orchestration & Classroom Intelligence

**Archived:** 2026-05-15
**Status:** ARCHIVED (Phase 21-26 complete; known gaps remain outside this milestone close)

For current requirements, see `.planning/REQUIREMENTS.md`.

## Archive note

- 这份 archive 只用于记录 v1.3 的真实 close scope：Phase 21-26。
- `COURSE-04` ~ `COURSE-09`、`AUTH-01` ~ `AUTH-06`、`DATA-01` ~ `DATA-05`、`CLASS-05` 仍是项目级 known gaps，不因本次归档自动变为 complete。
...
*Last updated: 2026-05-15 after reconciling v1.3 archive scope to Phase 21-26 and restoring known gaps*
