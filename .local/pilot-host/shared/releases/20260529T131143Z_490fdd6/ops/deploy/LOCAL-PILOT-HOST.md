...
- `.local/pilot-host/shared`
- `.local/pilot-host/runtime-assets`
- `.local/pilot-host/manifests`
...
For local pilot-host rehearsal only, `deploy.sh` may link `OPENLEARN_SOURCE_NODE_MODULES` into the release tree.
