...
**Phases:** 6
**Granularity:** coarse
**Coverage:** Archive close only covers Phase 21-26; unfinished project requirements remain outside this milestone close as known gaps.
...
- 本归档只覆盖 Phase 21-26 的真实交付。
- Phase 14/15 仍是 carry-over backlog，不计入 v1.3 close。
- `AUTH-01`~`AUTH-06`、`DATA-01`~`DATA-05`、`CLASS-05` 继续保留为 known gaps。
