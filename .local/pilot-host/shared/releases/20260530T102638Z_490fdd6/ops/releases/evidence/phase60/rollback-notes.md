...
- [x] Rollback target release id: `20260530T090415Z_490fdd6`
- [x] Canonical rollback path stays on `ops/deploy/rollback.sh`.

## Execution steps

- [x] Command: `bash ops/deploy/rollback.sh --release-id 20260530T090415Z_490fdd6 --reason Sample smoke regression was selected as the controlled rollback rehearsal trigger. --shared-root /home/wuxf/Develop/OpenLearn-Next/.local/pilot-host/shared --current-root /home/wuxf/Develop/OpenLearn-Next/.local/pilot-host/current --base-url http://127.0.0.1:3000`
