...
This project is indexed by GitNexus as **OpenLearn-Next** (5972 symbols, 11033 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
