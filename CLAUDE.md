...
This project is indexed by GitNexus as **OpenLearn-Next** (6049 symbols, 11184 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
