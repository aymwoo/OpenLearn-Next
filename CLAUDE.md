...
This project is indexed by GitNexus as **OpenLearn-Next** (7637 symbols, 14104 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
