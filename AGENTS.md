...
This project is indexed by GitNexus as **OpenLearn-Next** (8644 symbols, 15684 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
