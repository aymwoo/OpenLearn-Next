...
This project is indexed by GitNexus as **OpenLearn-Next** (8955 symbols, 16174 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
